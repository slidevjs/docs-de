...
<<<<<<< HEAD:.vitepress/theme/components/demo/Demo.vue
    .type('<br><span class="token title"># Willkommen bei Slidev!</span><br><br>',{ delay: 400 })
    .type('Präsentationsfolien für Entwickler', { delay: 400 })
    .move('START', { speed: 0 })
=======
...
>>>>>>> 21fdadc17cd2018f65c637e5727de640db5036e3:.vitepress/theme/components/Demo.vue
    ...
    .type('<span class="token title"># Seite 2</span><br><br>', { delay: 400 })
    .type('- 📄 Erstelle Folien in einer einzelnen Markdown Datei<br>', { delay: 800 })
    .type('- 🌈 Themes, Code Blöcke, interaktive Komponenten<br>', { delay: 800 })
    .type('- 😎 Lies die Dokumentation um mehr zu erfahren!', { delay: 800 })
